...
public class NangoMyUnifiedNativeAd {
    ...
    private void populateUnifiedNativeAdView(UnifiedNativeAd nativeAd, UnifiedNativeAdView adView) {
        ...
        if (vc.hasVideoContent()) {
            Log.e("hasVideoContent", "Video status: Ad contains a %.2f:1 video asset." +
                    vc.getAspectRatio());
            ...
            vc.setVideoLifecycleCallbacks(new VideoController.VideoLifecycleCallbacks() {
                ...
                public void onVideoEnd() {
                    ...
                    Log.e("hasVideoContent", "Video status: Video playback has ended.");
                    super.onVideoEnd();
                }
            });
        } else {
     ...
     */
    public void showNativeAd(Activity activity, ViewGroup frameLayout, View process) {
